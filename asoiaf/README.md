...
- [`public/review/agot-recovery-to-review-handoff-v1/`](public/review/agot-recovery-to-review-handoff-v1/README.md) carries the exact Windows-first physical recovery and metadata-only locator handoff for the four accepted private object identities.
- [`public/review/agot-recovery-handoff-runner-v1/`](public/review/agot-recovery-handoff-runner-v1/README.md) verifies, reconstructs, and safely extracts the exact admitted Windows recovery handoff directly from the repository carrier without acquiring private-source or review authority.
