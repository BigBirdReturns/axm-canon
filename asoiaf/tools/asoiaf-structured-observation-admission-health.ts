...
} from "./lib/asoiaf-structured-observation-admission-health.js";
...
function usage(): void {
  process.stdout.write("ASOIAF structured observation admission health\n\n");
  process.stdout.write("Commands:\n");
  process.stdout.write("  audit   Inspect admission state, history, acquisition parity, collector custody, and disposition drift\n");
  process.stdout.write("  verify  Return only blocking admission-health findings\n\n");
...
try {
  switch (command) {
    case "audit": {
      print(auditAsoiafStructuredObservationAdmissionHealth(root));
      break;
    }
    case "verify": {
